...
export const Btn = ({
  ...
  return (
    <button
      ...
      onMouseEnter={(e) => {
        if (!disabled && !loading) e.target.style.opacity = "0.85";
      }}
      onMouseLeave={(e) => {
        if (!disabled && !loading) e.target.style.opacity = "1";
      }}
    >
      {loading ? (
...
export const Field = ({
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
      ...
      <div style={{ position: "relative" }}>
        <input
          ...
          style={{
            ...
            paddingRight: isPass ? "40px" : undefined,
          }}
        />
        {isPass && (
          <button
      ...
      {hint && !error && (
        <span style={{ fontSize: "12px", color: "var(--text3)" }}>{hint}</span>
      )}
    </div>
  );
};
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h3 style={{ fontSize: "16px", fontFamily: "var(--font-display)" }}>
            {title}
          </h3>
          <button
            onClick={onClose}
    ...
    >
      ...
      <div
        style={{
          ...
          height: "44px",
          borderRadius: "10px",
          background: `var(--${color}-dim, var(--accent-dim))`,
          display: "flex",
          alignItems: "center",
          justifyContent: "center",
...
export const Empty = ({ icon, title, desc, action }) => (
  <div style={{ textAlign: "center", padding: "60px 20px" }}>
    ...
    <h3
      style={{ fontSize: "16px", marginBottom: "8px", color: "var(--text2)" }}
    >
          ...
          rows.map((row, i) => (
            ...
            >
              {row.map((cell, j) => (
                <td
                  key={j}
                  style={{ padding: "12px 14px", color: "var(--text)" }}
                >
                  {cell}
                </td>
              ))}
...
export const PageHeader = ({ title, subtitle, action }) => (
  ...
  >
    <div>
      ...
      {subtitle && (
        <p style={{ fontSize: "14px", color: "var(--text3)" }}>{subtitle}</p>
      )}
    </div>
    {action}
  </div>
