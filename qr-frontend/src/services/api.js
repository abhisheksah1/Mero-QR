...
export const resetRestaurantPassword = (id, d) =>
  api.patch(`/platform/restaurants/${id}/reset-password`, d);
export const updateKYC = (id, d) =>
  api.patch(`/platform/restaurants/${id}/kyc`, d);
...
// ── Restaurant Auth
export const restaurantRegister = (d) =>
  api.post("/restaurant/auth/register", d);
export const restaurantLogin = (d) => api.post("/restaurant/auth/login", d);
export const forgotPassword = (d) =>
  api.post("/restaurant/auth/forgot-password", d);
export const resetPassword = (d) =>
  api.post("/restaurant/auth/reset-password", d);
...
export const updateMenuItem = (id, d) =>
  api.patch(`/restaurant/menu/items/${id}`, d);
...
export const changeEmployeePassword = (d) =>
  api.patch("/restaurant/employees/change-password", d);

// ── Orders
export const placeOrder = (d) => api.post("/restaurant/orders/place", d);
export const getOrders = (status) =>
  api.get("/restaurant/orders" + (status ? `?status=${status}` : ""));
export const updateOrderStatus = (id, d) =>
  api.patch(`/restaurant/orders/${id}/status`, d);

// ── Cashier
export const processPayment = (d) => api.post("/restaurant/cashier/pay", d);
export const getTransactions = () =>
  api.get("/restaurant/cashier/transactions");
