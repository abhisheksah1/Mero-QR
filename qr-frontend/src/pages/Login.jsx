      ...
      >
        ...
        >
            ...
            {tabs.map((t) => (
              <button
                ...
                style={{
                  ...
                  boxShadow:
                    tab === t.id ? "0 1px 4px rgba(0,0,0,0.3)" : "none",
                }}
              >
                {t.label}
              </button>
          ...
          >
            ...
            {tab !== "employee" ? (
              ...
              <>
                <Field
                  ...
                  required
                  hint="Get this from your restaurant admin"
                />
                <Field
                  label="Username"
                  name="username"
            ...
            <Btn type="submit" fullWidth loading={loading} size="lg">
              Sign In
            </Btn>
